...
<div class="form-container">
   ...
   <form action="" method="post">
      <h3>login now <br> (लगइन गर्नुहोस्)</h3>
      ...
      <input type="submit" name="submit" value="login now/लगइन गर्नुहोस् " class="btn">
      <p>Don't Have An Account?/खाता छैन? <a href="register.php">Register now/दर्ता गर्नुहोस्</a></p>
   </form>
